...
# --- 2. Baseline run ---
python3 -m pyperformance run --bench nbody -o "$REPO_ROOT/reports/baseline_nbody.json"
...
python3 -m pyperf compare_to "$REPO_ROOT/reports/baseline_nbody.json" "$REPO_ROOT/reports/nbody_optimized.json"
