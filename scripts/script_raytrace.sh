...
# --- 2. Baseline run ---
python3 -m pyperformance run --bench raytrace -o "$REPO_ROOT/reports/baseline_raytrace.json"
...
python3 -m pyperf compare_to "$REPO_ROOT/reports/baseline_raytrace.json" "$REPO_ROOT/reports/raytrace_optimized.json"
